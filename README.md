...
- Replace gnome-clocks with the name of the snap (ex. gnome-clocks).
- Update any section starting with "TODO" to add the info requested, and remove the TODO line.

========================================================================================
# gnome-clocks

TODO: Add links to badges. Here's the gnome-clocks badge links for example:
*[![gnome-clocks](https://snapcraft.io/gnome-clocks/badge.svg)](https://snapcraft.io/gnome-clocks)
[![gnome-clocks](https://snapcraft.io/gnome-clocks/trending.svg?name=0)](https://snapcraft.io/gnome-clocks)*
...
git remote add ubuntu https://github.com/ubuntu/gnome-clocks.git
git fetch --all
```
